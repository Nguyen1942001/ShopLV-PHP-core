...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Đănh nhập để vào phần quản trị</p>
                ...
                <p class="mb-1">
                    <a href="javascript:void(0)" onclick="alert('Chức năng sắp có!!')">Quên mật khẩu</a>  <!-- Chưa làm chức năng này -->
                </p>
            </div>
            <!-- /.login-card-body -->
        </div>
    ...
    <!-- AdminLTE App -->
    <script src="public/css/js/adminlte.min.js"></script>
</body>
