                            ...
                            <tbody>
                                <?php foreach ($customers as $customer): ?>
                                    <tr>
                                        ...
                                        <td><?=ucfirst($customer->getLoginBy())?></td>
                                        <td><?=$customer->getMobile()?></td>
                                        <td><?=$customer->getAddress()?></td>
                                        <td><?=$customer->getIsActive() == 1 ? "Đã kích hoạt" : "Chưa kích hoạt"?></td>
                                        <td><a href="index.php?c=customer&a=edit&customer_id=<?=$customer->getId()?>" class="btn btn-warning btn-sm">Sửa</a></td>
                                        <td><a data="<?=$customer->getId()?>" href="index.php?c=customer&a=delete&customer_id=<?=$customer->getId()?>" class="btn btn-danger btn-sm btn-delete-customer">Xóa</a></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                            <tfoot>
