                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><a href="index.php?c=comment&a=delete&comment_id=<?=$comment->getId()?>&product_id=<?=$product_id?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn muốn xóa bài đánh giá này?')">Xóa</a></td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
                            <tfoot>
