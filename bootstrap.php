...
require_once "../model/productDetail/ProductDetail.php";
require_once "../model/productDetail/ProductDetailRepository.php";
...
//http://
// Lấy phương thức protocol
function getProtocol() {
	$protocol = ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://";
	return $protocol;
}

// Vừa lấy domain vừa lấy protocol
// http://web.com
function get_domain(){
